...
User = get_user_model()  # Use Django's built-in User model
...
class Client(models.Model):
    ...
    """
    user = models.OneToOneField(User, on_delete=models.CASCADE, related_name='client_profile', verbose_name=_('User'))
