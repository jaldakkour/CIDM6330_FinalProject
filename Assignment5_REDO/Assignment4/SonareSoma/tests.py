...
class GoalModelTests(TestCase):
    def test_goal_creation(self):
        ...
        # Assertions
        self.assertEqual(goal.goaltype, "Weight Loss")
        self.assertEqual(goal.goalvalue, 10)
        self.assertEqual(goal.client, client)
        self.assertEqual(goal.professional, professional)
...
class GoalSerializerTests(TestCase):
    def test_goal_serializer_validation(self):
        ...
        # Invalid data (enddate before startdate)
        data = {
            "goaltype": "Weight Loss",
            "goalvalue": 10,
